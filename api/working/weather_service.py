...
class WeatherService:
    ...
    async def get_forecast(self, lat: float, lon: float, days: int = 7) -> Dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"Weather forecast unavailable for coordinates: {lat}, {lon}")
    ...
    async def get_historical_weather(self, lat: float, lon: float, date: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"Historical weather data unavailable for coordinates: {lat}, {lon}")
    ...
    # Fallback methods removed - real data only for accuracy verification

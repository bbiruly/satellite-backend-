#!/usr/bin/env python3
"""
Create comprehensive NPK+Boron+Iron map showing all five nutrients
"""
...
def create_comprehensive_npk_boron_iron_map():
    """Create interactive map with Nitrogen, Phosphorus, Potassium, Boron, and Iron zones"""
    ...
    for village in data['village_wise_data']['villages']:
        if 'coordinates' in village and len(village['coordinates']) == 2:
            ...
            folium.Marker(
                ...
                tooltip=f"{village['village_name']} - N:{nitrogen_level}, P:{village.get('phosphorus_level', 'N/A')}, K:{village.get('potassium_level', 'N/A')}, B:{village.get('boron_level', 'N/A')}, Fe:{village.get('iron_level', 'N/A')}"
            ).add_to(m)
    
    # Add comprehensive legend
    legend_html = f'''
    <div style="position: fixed; 
                bottom: 50px; left: 50px; width: 500px; height: 450px; 
                background-color: white; border:2px solid grey; z-index:9999; 
                font-size:11px; padding: 10px; border-radius: 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.2);">
        <h4 style="margin-top:0; color: #333; text-align: center;">Kanker District Complete Nutrient Zones</h4>
        
        <div style="margin: 3px 0;">
            <h5 style="color: #2E8B57; margin: 2px 0;">🌱 Nitrogen Zones:</h5>
            <div style="margin: 1px 0; font-size: 9px;">
        ...
        <div style="margin: 3px 0;">
            <h5 style="color: #B22222; margin: 2px 0;">⚡ Iron Zones:</h5>
            <div style="margin: 1px 0; font-size: 9px;">
        ...
        <div style="margin: 3px 0;">
            ...
            <div style="margin: 1px 0; font-size: 9px;">
                ...
                <span style="color: blue; margin-left: 6px;">●</span> Low-Medium N
                <span style="color: orange; margin-left: 6px;">●</span> Medium N
            </div>
            <div style="margin: 1px 0; font-size: 9px;">
                <span style="color: red;">●</span> High N
                <span style="color: darkred; margin-left: 6px;">●</span> Very High N
            </div>
        </div>
        
        <div style="margin: 8px 0 0 0; padding: 6px; background-color: #f0f0f0; border-radius: 3px;">
            <p style="margin: 0; font-size: 9px; color: #666; text-align: center;">
                <b>Total Villages:</b> {len(data['village_wise_data']['villages'])} | 
                <b>Complete NPK+Boron+Iron Data</b>
            </p>
        </div>
    </div>
    '''
    ...
    # Save map
    map_filename = "kanker_complete_nutrient_map.html"
    m.save(map_filename)
    
    print(f"✅ Complete Nutrient Map Created: {map_filename}")
...
if __name__ == "__main__":
    create_comprehensive_npk_boron_iron_map()
